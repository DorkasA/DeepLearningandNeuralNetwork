...
st.markdown("<h4 style = 'margin: -30px; color: #280274; text-align: center; font-family: Copperplate Gothic'> Built by OBAMUYI M.V. </h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('182-1823128_robot-png-transparent-png.png',width = 500, caption = 'I reply all your questions')
